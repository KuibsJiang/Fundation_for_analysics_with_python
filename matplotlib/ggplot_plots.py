...
print(plt1)
print(meat.head())
plt2 = ggplot(aes(x='date',y='beef'),data=meat)+geom_line(color='purple',size=1.5,alpha=0.75)+stat_smooth(colour='blue',size=2.0,span=0.15)+xlab('Year')+ylab('Head of Cattle Slaughtered')+ggtitle('Beef Consumpyion Over Time')+theme_seaborn
print(plt2)
print(diamonds.head())
